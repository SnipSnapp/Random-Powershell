...
<#
    ...
    Rule syntax is documented in redirect-rules.example.txt
...
function Register-UserProxy {
    param([string] $Server, [string] $Bypass, [switch] $OverridePac)
    if (-not $script:OnWindows) {
    ...
    'Run' {
        ...
        try {
            ...
            if (-not $NoSystemProxy) {
                ...
                Register-UserProxy -Server "127.0.0.1:$ProxyPort" -Bypass $ProxyBypass -OverridePac:$OverridePac
